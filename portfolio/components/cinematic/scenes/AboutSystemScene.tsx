...
export default function AboutSystemScene({ progress }: SceneProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex justify-between items-baseline border-b border-[var(--color-border)]/60 pb-4 font-mono text-[11px] text-[var(--color-text-tertiary)] uppercase tracking-widest">
      ...
      >
        <div className="space-y-3">
          <span className="font-mono text-xs text-[var(--color-accent)] uppercase tracking-[0.2em] block">
            CORE PHILOSOPHY
          </span>
        ...
        {/* 3 Layered Depth Pillars */}
        <div className="grid grid-cols-1 tablet:grid-cols-3 gap-6 pt-4 font-body">
          {/* Pillar 1: Backend Systems */}
          <div className="border border-[var(--color-border)] p-5 tablet:p-6 bg-[#121212]/90 drafting-corner space-y-2">
