...
// Factual editorial About section for Ayush Trivedi
        ...
        <div className="grid laptop:grid-cols-12 gap-12 items-start">
          ...
          <div className="laptop:col-span-7 space-y-6">
            ...
            >
              ...
              My work spans object-oriented systems in Java, backend engineering with Spring Boot, Python machine learning research in Explainable AI (XAI), and modern responsive web development.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <p className="font-body text-[var(--color-text-secondary)] leading-relaxed text-sm tablet:text-base">
                ...
                I actively solve Data Structures and Algorithms (DSA) challenges on LeetCode, regularly participate in competitive programming, and participate in technical workshops to deepen my computational velocity and debugging rigor.
              </p>
            </div>
          ...
          {/* Right Column: Architectural Fact Cards */}
          <div className="laptop:col-span-5 space-y-4 font-mono text-xs">
            ...
            <div className="border border-[var(--color-border)] p-6 bg-[#141414]/50 space-y-3">
