  ...
  return (
    ...
    >
      <div className="max-w-[var(--max-width)] mx-auto">
              ...
              return (
                <motion.button
                  ...
                  className={`text-left p-6 border transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] ${
                    isActive
                      ? "border-[var(--color-accent)] bg-[#141414] ring-1 ring-[var(--color-accent)] shadow-lg shadow-[var(--color-accent-subtle)]/20"
        ...
        {/* Active Featured Case Study with AnimatePresence */}
